...
export const skills = {
  react: [
    ...
    },
    {
      ...
      icon: "/tools/react-router.svg",
    },
    {
      name: "Redux",
      icon: "/tools/redux.svg",
    },
    {
      name: "React Query",
...
export const experiences = [
  {
    ...
    description:
      "Collaborated in a study group to build modern React applications and practice real-world workflows through code reviews and teamwork.",
    responsibilities: [
      "Built several frontend apps using React, Next.js, Tailwind CSS, and TypeScript.",
      "Participated in code reviews and collaborative development in a study group setting.",
      "Worked on Podcraft (podcast platform), Kanba (Trello-style task manager), and World Ranks (country ranking app).",
      "Applied best practices in UI/UX, accessibility, and animation using Framer Motion and MUI.",
...
export const projects = [
  ...
  },
  {
    ...
    imageUrl: "/projects/cafe-store.png",
    projectLangs: [0],
    tags: [
      "Next.js",
      "Tailwind CSS",
